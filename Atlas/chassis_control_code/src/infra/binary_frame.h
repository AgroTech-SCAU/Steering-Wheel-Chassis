...
#define BINARY_FRAME_MSG_MCU_ARM_COMMAND_RESULT 0x28u
...
#define BINARY_FRAME_PI_CONTROL_MASK_SUCTION_VALID 0x04u
/* SUCTION_VALID：payload[36] 有效，0=关闭吸盘，1=打开吸盘；不置位则不改变吸盘状态。 */
