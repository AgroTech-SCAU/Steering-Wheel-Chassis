...
| 目录 | 说明 |
|---|---|
| `racom_vision/atlas_racom_vision_backend` | 适配器，把视觉检测服务转换成 Atlas 任务系统需要的视觉目标服务。 |
| `rui_vison/vison_topic` | RUI 视觉检测服务源码（ONNX YOLO 推理，当前默认）。 |
| `rui_vison/vison_topic_interfaces` | `VisionDetect.srv` 接口包。 |
