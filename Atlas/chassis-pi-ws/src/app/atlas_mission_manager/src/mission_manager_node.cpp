...
MissionManagerNode::MissionManagerNode(const rclcpp::NodeOptions& options)
  ...
  navigation_backend_ = declare_parameter<std::string>("navigation_backend", "full");
  ...
  manipulation_backend_ = declare_parameter<std::string>("manipulation_backend", "racom_vision");
